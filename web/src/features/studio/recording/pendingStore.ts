...
// server confirms the append (STUDIO_CONTRACT §5: "Never discard the audio blob
// until the server confirms append.").

import { create } from 'zustand';
import type { EvalPart, Role, Tier } from '../../../lib/api/types';
...
export interface PendingCapture {
  ...
  role: Role;
  eval_part: EvalPart;
  // WEB_CONTRACT §6: sticky tag captured at record time.
  tag: string | null;
